...
from transformers import GenerationConfig, GPTNeoXForCausalLM, AutoTokenizer
...
def main(
    ...
    lora_weights: str = "./lora_weights/final+",
    ...
    gr.Interface(
        ...
        title="LLM Chat Test",
        description="Now, using "+base_model,  # noqa: E501
